            ...
            <div class="modal-body">
                ...
                <form id="feedForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="feedQty" class="form-input" placeholder="Enter quantity" min="0" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="reorderLevel" class="form-label">Reorder Level *</label>
                        <input type="number" id="reorderLevel" class="form-input" placeholder="Enter reorder level" min="0" required>
                    </div>
                </form>
            </div>
